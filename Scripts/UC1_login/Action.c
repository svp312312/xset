Action()
{
	...
	/*Correlation comment - Do not change!  Original value='136159.304090725HAADzQtpcAtVzzzHtcAccpVzfccf' Name ='userSession' Type ='ResponseBased'*/
	...
	lr_end_transaction("UC1_login", LR_AUTO);
